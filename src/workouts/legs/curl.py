    ...
    def display_skeleton(self, img, results):
        ...
        try:
            ...
            if self.side != "both":
                ...
                # count reps
                utils.rep_counter(self, a_knee, self.side, min_angle, max_angle, tension_angle='low')
                ...
                # count reps
                utils.rep_counter(self, r_a_knee, 'right', min_angle, max_angle, tension_angle='low')
                utils.rep_counter(self, l_a_knee, 'left', min_angle, max_angle, tension_angle='low')
