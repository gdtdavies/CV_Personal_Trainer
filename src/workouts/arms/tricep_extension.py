    ...
    def display_skeleton(self, img, results):
        ...
        try:
            ...
            if self.side != "both":
                ...
                # count reps
                utils.rep_counter(self, a_elbow, self.side, min_angle, max_angle, tension_angle='high')
                ...
                # count reps
                utils.rep_counter(self, r_a_elbow, 'right', min_angle, max_angle, tension_angle='high')
                utils.rep_counter(self, l_a_elbow, 'left', min_angle, max_angle, tension_angle='high')
