...
from src.workouts.legs.extension import LegExtensionApp
from GUI.fonts import Fonts
import GUI.workouts.utils as utils


class LegExtensionGUI(tk.Tk):
    is_resting = False
    ...
    def __init__(self):
        ...
        self.workout_token = utils.start_workout("Leg Extension")
        self.set_token = None
        ...
        self.app = LegExtensionApp(self.app_frame, (self.left_var, self.right_var),
        ...
        # Title frame --------------------------------------------------------------------------------------------------
        title_label = tk.Label(gui_frame, text="Leg Extension", font=f['title'], bg=cp['label'])
        ...
        image_path = os.path.join(os.path.dirname(__file__), './assets/extension.png')
        ...
        utils.add_message(self, "Welcome to the Leg Extension workout. Please set the weight and rest time before "
