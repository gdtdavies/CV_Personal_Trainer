...
from src.workouts.arms.tricep_extension import TricepExtensionApp
from GUI.fonts import Fonts
import GUI.workouts.utils as utils


class TricepExtensionGUI(tk.Tk):
    is_resting = False
    ...
    def __init__(self):
        ...
        self.workout_token = utils.start_workout("Tricep Extension")
        self.set_token = None
        ...
        # initialise the TricepExtensionApp here because it is referenced by side buttons, packed later
        self.app = TricepExtensionApp(self.app_frame, (self.left_var, self.right_var),
        ...
        # Title frame --------------------------------------------------------------------------------------------------
        title_label = tk.Label(gui_frame, text="Tricep Extension", font=f['title'], bg=cp['label'])
        ...
        image_path = os.path.join(os.path.dirname(__file__), './assets/tricep_extension.png')
        utils.load_image(self, image_path)

        # -Start/Stop Set frame--------------------------------------------------BicepCurlsApp---------------------------------------
        ...
        utils.add_message(self, "Welcome to the Tricep Extension workout. Please set the weight and rest time "
