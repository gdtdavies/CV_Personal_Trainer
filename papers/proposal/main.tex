        ...
        \begin{figure}[htbp]
            ...
            \begin{sideways}
                \begin{ganttchart}[y unit title=0.4cm,
                    ...
                    \ganttmilestone{First system version}{21}\\
                    \ganttbar{Coding}{24}{53}\\
                    \ganttmilestone{Final sytem version}{53}\\
                    \ganttbar{Paper Writing}{45}{59}\\
                    \ganttmilestone{Sumbission Deadline}{60}\\
                    \ganttbar{Viva Preparation}{62}{77}\\
                    \ganttmilestone{In Person Viva}{78}
...
\newpage
\printbibliography
\centering{\large{\textbf{Word Count: 2052}}}
\end{document}
